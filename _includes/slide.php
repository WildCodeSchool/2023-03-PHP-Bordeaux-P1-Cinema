  ...
  <div class="container">
    ...
    <div class="cards">
      ...
      <label for="s2" id="slide2">
        <div class="card">
          <div class="image">
            <img src="assets\images\cred3.jpg" alt="">
            <div class="dots">
              <div class="dot1"></div>
              <div class="dot2"></div>
              <div class="dot3"></div>
      ...
      <label for="s3" id="slide3">
        <div class="card">
          <div class="image">
            <img src="assets\images\Mon_Crime.jpg" alt="">
            <div class="dots">
              <div class="dot1"></div>
              <div class="dot2"></div>
              <div class="dot3"></div>
      ...
      <label for="s4" id="slide4">
        <div class="card">
          <div class="image">
            <img src="assets\images\pussInBootsTwo.png" alt="">
            <div class="dots">
              <div class="dot1"></div>
              <div class="dot2"></div>
              <div class="dot3"></div>
      ...
      <label for="s5" id="slide5">
        <div class="card">
          <div class="image">
            <img src="assets\images\scream6.jpeg" alt="">
            <div class="dots">
              <div class="dot1"></div>
              <div class="dot2"></div>
              <div class="dot3"></div>
